...
class _TableCalendarState extends State<TableCalendar> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    widget.calendarController._init(
      ...
      initialDay: widget.initialSelectedDay ?? DateTime.now(),
        ...
        child: GestureDetector(
          ...
          child: Text(
            widget.headerStyle.titleTextBuilder != null
                ...
                : (widget.calendarController.focusedDay == null
                    ? ""
  ...
  Widget _buildCell(DateTime date) {
    ...
    Widget content = _buildCellContent(date) ?? const SizedBox.shrink();
  ...
  Widget? _buildCellContent(DateTime date) {
    ...
    if (isUnavailable) {
      return widget.builders.unavailableDayBuilder
          ?.call(context, date, widget.calendarController.visibleEvents[eventKey] ?? []);
